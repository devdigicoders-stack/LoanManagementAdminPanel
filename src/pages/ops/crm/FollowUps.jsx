...
const mockFollowUps = [
  { id: 'FU-1001', customer: 'John Doe', leadId: 'LD-10025', date: 'Today', time: '10:30 AM', mode: 'Call', status: 'Pending', remarks: 'Customer requested callback in morning.', executive: 'Rahul S.' },
  { id: 'FU-1002', customer: 'Priya Sharma', leadId: 'LD-10026', date: 'Today', time: '02:00 PM', mode: 'WhatsApp', status: 'Pending', remarks: 'Send product brochure.', executive: 'Meena K.' },
  { id: 'FU-1003', customer: 'Amit Patel', leadId: 'LD-10027', date: 'Tomorrow', time: '11:00 AM', mode: 'Meeting', status: 'Scheduled', remarks: 'Branch visit for document collection.', executive: 'Vikram Singh' },
  { id: 'FU-1004', customer: 'Anita Desai', leadId: 'LD-10029', date: 'Today', time: '09:00 AM', mode: 'Call', status: 'Completed', remarks: 'Not reachable. Left SMS.', executive: 'Rahul S.' },
];
